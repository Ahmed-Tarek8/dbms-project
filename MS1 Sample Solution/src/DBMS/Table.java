...
public class Table implements Serializable
{
	...
	private ArrayList<String> indexedColumns = new ArrayList<String>();
	...
	public String[] returncolumnsnames() {
		return columnsNames;
	}
	...
	public void addIndexedColumn(String col){
		if(getIndexedColumns().contains(col)==false){
			getIndexedColumns().add(col);
		}
	}
	...
	public String getFullTrace() 
	{
		...
		return res+ "Pages Count: " + pageCount + ", Records Count: " + recordsCount+ ", Indexed Columns: " + getIndexedColumns();
	}
